...
const payload = {
    ...
    describeName: "Get Carrier comparison Graph",
    controller: CarrierTypeController,
    moduleName: "getCarrierTypeComparisonGraph",
    testCases: [
        {
            status: true,
            mockConnection: mockConnection,
            testName: "should return 200 with carrier comparison graph data",
            body: {
                region_id: 1,
                year: 2024,
                time_id: 2,
            ...
            responseStatus: 200,
            responseMessage: "Carrier comparison data",
        },
        {
            status: true,
            mockConnection: {
            ...
            testName: "should return 200 with not found message when carrier comparison graph data is empty",
            body: {
                region_id: 2,
                year: 2023,
                time_id: 1,
