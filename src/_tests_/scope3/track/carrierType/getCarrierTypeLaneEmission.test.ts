...
const payload = {
    ...
    describeName: "Get Carrier lane emissions",
    controller: CarrierTypeController,
    moduleName: "getCarrierTypeLaneEmission",
    testCases: [
        {
            status: true,
            mockConnection: mockConnection,
            testName: "should return 200 with carrier lane emissions data",
            body: {
                region_id: 1,
                year: 2024,
                time_id: 2,
            ...
            responseStatus: 200,
            responseMessage: "Carrier Type Lane Emissions",
        },
        {
            status: true,
            mockConnection: {
