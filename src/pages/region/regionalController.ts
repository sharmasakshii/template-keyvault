...
import { regionGraphData, regionTableData } from 'store/scopeThree/track/region/regionSlice';
...
const RegionalController = () => {
  ...
  const { regionTableDetails, isLoading, regionGraphDetails, regionGraphDetailsLoading } = useAppSelector((state: any) => state.region);
