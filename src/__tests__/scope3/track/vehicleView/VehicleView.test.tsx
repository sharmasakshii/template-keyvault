...
import VehicleWrapperView from "pages/vehicle/VehicleWrapper";
...
describe("test lane view for facility ", () => {
    ...
    //section id.....
    it(`<section> test case for by vehicle view page `, async () => {
        await renderVehicleView();
        expect(screen.getByTestId("Vehicle-view")).toBeInTheDocument();
    });

    it("should read vehicleGraphDto and vehicleGraphDtoLoading from redux state", async () => {
        // Mock your Redux selector
        jest
        ...
        // Now assert UI or component behavior based on those values
    });
});
